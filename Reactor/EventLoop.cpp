...
//不应在C++中创建static全局变量。应该使用未命名的命名空间。
/*
      ...
      currentActiveChannel_(NULL)
{
    ...
    // 在这里会自己加入到Poller中
    // 调用Channel::updata->EventLoop::updateChannel
...
void EventLoop::loop()
{
    ...
    while (!quit_)
    {
        ...
        //调用Poller::poll，获得活跃事件，会更新activeChannels_
